...
public class CustomTest {
	/*
	private CustomMsgService customService = new CustomMsgService();
	...
	public void testAddAccount(){
		...
		a.setKfAccount("test1@test");
		a.setNickname("测试工号1");
		a.setPassword("12345");
		System.out.println(gson.toJson(customService.addAccount(getAccessToken(), a)));
	}*/
